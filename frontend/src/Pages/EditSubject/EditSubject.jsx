...
const CreateSubject = () => {
    ...
    useEffect(() => {
        const getLatestVersion = async () => {
            const response = await axios.get(
                `https://b8ow8oc.bct.itclub.pp.ua/api/subject/get-latest-version/${selectedSubject}`
            );
    ...
    const submitHandler = async () => {
        ...
        if (pdfFile) {
            ...
            const response1 = await axios.post(
                "https://b8ow8oc.bct.itclub.pp.ua/api/subject/upload-file",
                pdfData,
                config
            );
            ...
            const changedPdf = await axios.put(
                `https://b8ow8oc.bct.itclub.pp.ua/api/subject/update-syllabus-pdf/${selectedSubject}`,
                {
                    id: subjVersionId,
                    pdf: response1.data,
                }
            ...
            const response2 = await axios.put(
                `https://b8ow8oc.bct.itclub.pp.ua/api/subject/${selectedSubject}`,
                {
                    name,
                    subjectCode,
                    semester,
            ...
            const response = await axios.post(
                `https://b8ow8oc.bct.itclub.pp.ua/api/subject/upload`,
                fileData,
                config
            );
    ...
    useEffect(() => {
        const getPrograms = async () => {
            try {
                const response = await axios.get(
                    "https://b8ow8oc.bct.itclub.pp.ua/api/program/all"
                );
    ...
    useEffect(() => {
        const getAllSubjects = async () => {
            const response = await axios.get(
                "https://b8ow8oc.bct.itclub.pp.ua/api/subject/all"
            );
    ...
    const versionSubmitHandler = async (e) => {
        ...
        if (pdfFile) {
            ...
            const response1 = await axios.put(
                `https://b8ow8oc.bct.itclub.pp.ua/api/subject/new-version/${selectedSubject}`,
                {
                    syllabus: {
                        pdf: response.data,
                        version: versionName,
                ...
                >
                    ...
                    <div className="formInput">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setSemester(e.target.value.toString())
                            }
                        />
                    </div>
